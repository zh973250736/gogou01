package cn.itsource.gogou.generator;
...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        // 如果模板引擎是 velocity
         String templatePath = "/templates/mapper.xml.vm";//可以替换成自己的模板
        ...
        focList.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                return projectPath + "/src/main/resources/cn/itsource/gogou/mapper/"
